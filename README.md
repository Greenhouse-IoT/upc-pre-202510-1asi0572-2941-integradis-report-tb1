...
| **US07** | Visualizar Perfil de Usuario Mobile                    | Como técnico supervisor o administrador, Quiero visualizar el perfil de un usuario desde la app móvil, Para consultar su información desde cualquier ubicación. | Escenario 1: Acceso exitoso; Dado que accede desde su teléfono; Entonces muestra los datos del perfil. <br> Escenario 2: Error de conexión; Dado que hay un fallo de red; Entonces no se muestra la información.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | EP04             |
...
| **US09** | Crear Cuenta de Empresa Mobile| Como administrador de la fábrica, Quiero registrar mi empresa desde la app móvil, Para iniciar sesión y delegar funciones a mi equipo en campo.| Escenario 1: Datos válidos; Dado que el administrador registra la empresa en la app; Entonces se crea correctamente la cuenta. <br> Escenario 2: Datos inválidos; Dado que los datos están incompletos o incorrectos; Entonces se muestra un mensaje de error.| EP05             |
...
| **US12** | Editar y Eliminar Cultivos Web |Como administrador de la fábrica, Quiero editar o eliminar cultivos existentes desde la plataforma web, Para mantener la información de producción actualizada.| Escenario 1: Eliminación; Dado que el administrador confirma; Entonces se borra el cultivo. <br> Escenario 2: Cancelación; Dado que el administrador niega; Entonces no se borra.| EP06             |
...
| **US14** |Ver Listado de Cultivos en Progreso Web| Como administrador de la fábrica, Quiero ver un listado de los cultivos actualmente en progreso, Para poder hacer un seguimiento del avance.                                                                              |Escenario 1: Listado correcto; Dado que accede a la lista; Entonces muestra cultivos. <br> Escenario 2: Error; Dado que hay un fallo; Entonces muestra mensaje de error.| EP06             |
...
| **US16** |Visualizar Perfil de Usuario Web| Como técnico supervisor o administrador, Quiero visualizar el perfil de un usuario desde la versión web, Para revisar sus datos y roles desde el escritorio.| Escenario 1: Acceso exitoso; Dado que entra al perfil; Entonces muestra datos. <br> Escenario 2: Error de conexión; Dado que hay fallo; Entonces no muestra información.| EP05             |
...
| **US21** | Captura de Parámetros Ambientales desde Sensores | Como sistema embebido, Quiero capturar los valores de temperatura, humedad y CO₂, Para enviarlos al sistema de procesamiento en el borde. | Escenario 1: Sensor responde; Dado que el sensor está conectado; Cuando se hace una solicitud REST; Entonces devuelve los valores actuales. <br> Escenario 2: Sensor sin respuesta; (no contemplado actualmente). | EP01 |
| **US22** | Envío de Datos al Nodo Edge | Como sistema embebido, Quiero enviar los datos capturados al nodo edge a través de REST, Para que puedan ser procesados y actuar si es necesario. | Escenario 1: Comunicación activa; Dado que se genera una lectura; Cuando se hace POST al endpoint del edge; Entonces se transmite exitosamente la medición. | EP01 |
| **US23** | Procesamiento de Umbrales Ambientales | Como sistema de borde, Quiero procesar los valores de temperatura, humedad y CO₂ recibidos, Para determinar si superan umbrales preestablecidos. | Escenario 1: Umbral superado; Dado que los valores exceden el límite; Entonces se activa una señal de alerta o acción. <br> Escenario 2: Dentro del umbral; Dado que los valores están en rango; Entonces no se activa ninguna acción. | EP01 |
| **US24** | Activación de Servomotores según Parámetros | Como sistema de borde, Quiero activar servomotores cuando se detecten condiciones críticas, Para ventilar o regular el ambiente automáticamente. | Escenario 1: Condición crítica; Dado que la temperatura o CO₂ están fuera de rango; Entonces se activa el servomotor configurado. | EP01 |
| **US25** | Visualización Local en Pantalla LCD | Como sistema de borde, Quiero mostrar los valores actuales de temperatura, humedad y CO₂ en un LCD, Para que los operarios puedan verlos directamente en el campo. | Escenario 1: Nueva medición disponible; Dado que se recibe un valor actualizado; Entonces se refleja en la pantalla LCD. | EP01 |
| **US26** | Envío de Datos a la Nube vía Wi-Fi | Como sistema de borde, Quiero enviar los valores de sensores procesados a la nube mediante Wi-Fi, Para que puedan ser visualizados desde la web y móvil. | Escenario 1: Conectividad disponible; Dado que el sistema tiene Wi-Fi activo; Entonces publica los datos hacia el backend por REST. | EP01 |
| **US27** | Acceso a Datos Históricos Mobile | Como administrador de la fábrica, Quiero tener acceso a los datos históricos registrados desde la app móvil, Para hacer consultas rápidas sobre el desempeño de los cultivos en campo. | Escenario 1: Acceso correcto; Dado que el usuario accede desde su dispositivo móvil; Cuando ingresa al histórico; Entonces se muestran todos los registros. <br> Escenario 2: Falla en obtención; Dado que hay una falla en la obtención de registros; Cuando accede desde el móvil; Entonces no se muestra ningún dato. | EP03 |
| **US28** | Crear Cuenta de Empresa Web | Como administrador de la fábrica, Quiero crear una cuenta para mi empresa desde la plataforma web, Para permitir el acceso a los trabajadores. | Escenario 1: Datos válidos; Dado que el administrador ingresa datos válidos; Entonces se crea la cuenta. <br> Escenario 2: Datos inválidos; Dado que el administrador ingresa datos inválidos; Entonces se deniega la operación. | EP05 |
| **US29** | Editar y Eliminar Cultivos Mobile | Como administrador de la fábrica, Quiero poder editar o eliminar cultivos desde la aplicación móvil, Para realizar ajustes directamente en campo. | Escenario 1: Eliminación; Dado que el administrador confirma desde su dispositivo; Entonces se borra el cultivo. <br> Escenario 2: Cancelación; Dado que el administrador cancela la acción; Entonces no se borra nada. | EP06 |
| **US30** | Ver Listado de Cultivos en Progreso Mobile | Como administrador de la fábrica, Quiero ver un listado de cultivos en progreso desde la app móvil, Para supervisar los cultivos mientras me desplazo por la fábrica. | Escenario 1: Listado correcto; Dado que accede desde el móvil; Entonces muestra cultivos. <br> Escenario 2: Error; Dado que hay un fallo; Entonces muestra mensaje de error. | EP06 |
...
| 3       | US05          | Acceso a Datos Históricos Web| Como administrador de la fábrica, Quiero tener acceso a los datos históricos registrados desde la aplicación web, Para poder hacer análisis a largo plazo y optimizar los procesos de cultivo.cultivo.                                                    | 3            |
...
| 12      | US12          | Editar y Eliminar Cultivos Web                                                      | Como administrador de la fábrica, Quiero editar o eliminar cultivos existentes desde la plataforma web, Para mantener la información de producción actualizada.| 2            |
...
| 14      | US09          | Crear Cuenta de Empresa Mobile|Como administrador de la fábrica, Quiero registrar mi empresa desde la app móvil, Para iniciar sesión y delegar funciones a mi equipo en campo.| 2 |
...
| 16      | US16          | Visualizar Perfil de Usuario Web| Como técnico supervisor o administrador, Quiero visualizar el perfil de un usuario desde la versión web, Para revisar sus datos y roles desde el escritorio.| 3            |
...
| 21  | US21   | Captura de Parámetros Ambientales desde Sensores | Como sistema embebido, Quiero capturar los valores de temperatura, humedad y CO₂, Para enviarlos al sistema de procesamiento en el borde. | 5 |
| 22  | US22   | Envío de Datos al Nodo Edge | Como sistema embebido, Quiero enviar los datos capturados al nodo edge a través de REST, Para que puedan ser procesados y actuar si es necesario. | 5 |
| 23  | US23   | Procesamiento de Umbrales Ambientales | Como sistema de borde, Quiero procesar los valores de temperatura, humedad y CO₂ recibidos, Para determinar si superan umbrales preestablecidos. | 5 |
| 24  | US24   | Activación de Servomotores según Parámetros | Como sistema de borde, Quiero activar servomotores cuando se detecten condiciones críticas, Para ventilar o regular el ambiente automáticamente. | 5 |
| 25  | US25   | Visualización Local en Pantalla LCD | Como sistema de borde, Quiero mostrar los valores actuales de temperatura, humedad y CO₂ en un LCD, Para que los operarios puedan verlos directamente en el campo. | 4 |
| 26  | US26   | Envío de Datos a la Nube vía Wi-Fi | Como sistema de borde, Quiero enviar los valores de sensores procesados a la nube mediante Wi-Fi, Para que puedan ser visualizados desde la web y móvil. | 4 |
| 27  | US27   | Acceso a Datos Históricos Mobile | Como administrador de la fábrica, Quiero tener acceso a los datos históricos registrados desde la app móvil, Para hacer consultas rápidas sobre el desempeño de los cultivos en campo. | 3 |
| 28  | US28   | Crear Cuenta de Empresa Web | Como administrador de la fábrica, Quiero crear una cuenta para mi empresa desde la plataforma web, Para permitir el acceso a los trabajadores. | 3 |
| 29  | US29   | Editar y Eliminar Cultivos Mobile | Como administrador de la fábrica, Quiero poder editar o eliminar cultivos desde la aplicación móvil, Para realizar ajustes directamente en campo. | 3 |
| 30 | US30   | Ver Listado de Cultivos en Progreso Mobile | Como administrador de la fábrica, Quiero ver un listado de cultivos en progreso desde la app móvil, Para supervisar los cultivos mientras me desplazo por la fábrica. | 3 |
...
| US05                 | Acceso a Datos Históricos Web                                                         | TK01          | Realizar vista de datos historicos                             | Generar seccion donde se van a mostrar todos los datos que hay                                                     | 4                  | Andres Soto       | Done   |
...
| US09                 | Crear Cuenta de Empresa Mobile                                                              | TK04          | Creacion de cuenta de la empresa                               | Desde la web app permitir al usuario generar su cuenta de empresa                                                  | 4                  | Carlo Seminario   | Done   |
...
| US12                 | Editar y Eliminar Cultivos Web                                                        | TK07          | Permitir que se pueda editar o eliminar cultivos               | Desde la web app o app movil permitir que los usuarios puedan modificar informacion de los cultivos o eliminarlos. | 4                  | Jherson Astuyauri | Done   |
...
| US14                 | Ver Listado de Cultivos en Progreso Web                                               | TK09          | Visualizacion de cultivos en progreso                          | Permitir a los usuarios ver los cultivos que se encuentran en progreso                                             | 4                  | Alan Galavis      | Done   |
...
| US27                 | Acceso a Datos Históricos Mobile                                                  | TK14          | Vista de historial en app móvil                                | Mostrar los datos históricos correctamente o manejar errores de carga desde la app móvil                           | 4                  | Alan Galavis      | Done   |
| US28                 | Crear Cuenta de Empresa Web                                                       | TK15          | Creación de cuenta empresarial desde web                       | Permitir al administrador crear cuenta desde la plataforma web con validación                                      | 4                  | Carlo Seminario   | Done   |
| US29                 | Editar y Eliminar Cultivos Mobile                                                 | TK16          | Modificar o eliminar cultivos desde app móvil                  | Desde la app móvil permitir editar o eliminar cultivos con confirmación del usuario                                | 4                  | Jherson Astuyauri | Done   |
| US30                 | Ver Listado de Cultivos en Progreso Mobile                                        | TK17          | Vista de cultivos en progreso en app móvil                     | Mostrar listado de cultivos activos y manejar errores                                                              | 4                  | Andres Soto       | Done   |
...
<table border="1">
  ...
  <tr>
    <td>US16</td>
    <td>Visualizar Perfil de Usuario web</td>
    <td>TK08</td>
...
<table border="1">
  ...
  <tr>
    ...
    <td>Para este sprint, se consideró aceptar como máximo 28 story points.</td>
  </tr>
  <tr>
    <th>Sum of Story Points</th>
    <td>28</td>
...
| URL en Microsoft Stream: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202110223_upc_edu_pe/ETeN-QVQdFFOqzY6Tax2sg8BZkQa9KLYEKppKdCtenRsVg?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=1PKX6w](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202110223_upc_edu_pe/ETeN-QVQdFFOqzY6Tax2sg8BZkQa9KLYEKppKdCtenRsVg?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=1PKX6w) |
| URL en YouTube: [https://youtu.be/7NJkRybK3Hs](https://youtu.be/7NJkRybK3Hs) |
| **Timing: 0:00-1:05**                                                         | 
...
Buscar aplicar Domain Driven Design en el desarrollo móvil se aproxima bastante a la experiencia que se obtiene al querer aplicar DDD en una aplicación web. Por lo que, no existe un salto de conocimientos que se deban adquirir, dado que DDD es un tema más conceptual que práctico. En consecuencia, logramos obtener un proyecto más escalable, tolerante al cambio, ordenado y fácil de manejar cuando la aplicación empieza a crecer en complejidad y tamaño. Asimismo, permite delegar y realizar cambios en el código de manera más fácil en lo que se refiere al trabajo colaborativo (haciendo un uso efectivo de github, branches, conventional commits, etc).

Adicionalmente, integrar un sistema basado en IoT con la aplicación móvil y web permite que el usuario pueda interactuar con los cultivos de manera más eficiente y efectiva. Esto se traduce en una mejor experiencia de usuario, ya que se pueden realizar acciones como monitorear el estado de los cultivos y controlar automáticamente los niveles de CO2, humedad y temperatura del ambiente.

Con el fin de evitar dejar elementos pendientes por temas de tiempo, recomendamos diseñar y especificar las features de la aplicación de manera gradual en cada sprint. De este modo, se partiría de operaciones básicas de CRUD y diseños simplistas que, con cada nuevo sprint y conocimiento del sprint velocity del equipo y habilidades, se pueda ir mejorando y puliendo adecuadamente para obtener un mejor producto. Aún así, el mayor problema de este enfoque resulta en un constante desarrollo de los elementos y artefactos de diseños correspondientes a la UX/UI. Por lo que, el equipo debe considerar si le puede llegar a suponer una ventaja o no el implementar la estrategia en el desarrollo/implementación del proyecto. Adicionalmente, se sugiere complementar el sistema basado en IoT con sensores y actuadores adicionales que permitan cubrir un mayor rango de parámetros ambientales y de cultivo, como por ejemplo sensores de humedad del suelo, sensores de luz y actuadores para el riego automático. Esto enriquecería la experiencia del usuario y mejoraría la precisión en el monitoreo y control de los cultivos.
En base a las respuestas que obtuvimos durante las entrevistas de validación a nuestros dos segmentos, recomendamos ampliamente que en futuros productos de software se incluya la posibilidad de que el usuario pueda seleccionar un tema de la aplicación (claro y oscuro), ya que este suele ser un factor implícito en la mayoría de aplicaciones móviles.
En síntesis, en base a todo lo mencionado anteriormente, hemos logrado desarrollar una aplicación que está orientada a las necesidades de los usuarios al priorizar sus requisitos y necesidades.

<h3>Video about the team</h3>

A continuacion se presenta el video about the team donde el team leader realiza una reflexion sobre el trabajo realizado y cada uno de los integrantes del equipo explica como logro cumplir con los outcomes del curso.

URL: [https://youtu.be/fsg0XGDO0T0](https://youtu.be/fsg0XGDO0T0)
